...
//base url
String url = 'http://172.177.130.178/'; //please add the '/' at the end of the url as 'https://yourwebsite.com/'
String mapkey = 'AIzaSyAXB8TIY0LK_WDMaWB-Qfl2TGGbOjNFyLk';
String mapStyle = '';
    ...
    if (userDetails.isNotEmpty && userDetails['role'] == 'driver') {
      ...
      if (userDetails['role'] == 'driver') {
        ...
        if(driverState.key!.contains('vehicle_type_icon')){
          if(driverState.child('vehicle_type_icon') != userDetails['vehicle_type_icon_for']){
            FirebaseDatabase.instance
              .ref()
              .child('drivers/${userDetails['id']}')
              .update({'vehicle_type_icon': userDetails['vehicle_type_icon_for']});
          }
        }else{
          FirebaseDatabase.instance
              .ref()
...
geolocs.LocationSettings locationSettings = (platform == TargetPlatform.android)
    ? geolocs.AndroidSettings(
        ...
        foregroundNotificationConfig:
          ...
          notificationText:
              "UB Driver will continue to receive your location in background",
